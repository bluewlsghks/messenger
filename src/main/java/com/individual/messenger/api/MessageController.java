...
public class MessageController {
    ...
    /** ???˜ì´ì§?ëª©ë¡: GET /api/messages?roomId=...&page=0&size=20 */
    @GetMapping
    ...
    /** ???ˆìŠ¤? ë¦¬: GET /api/messages/{roomId}?before=ISO&limit=50 */
    @GetMapping("/{roomId}")
